...
CREATE TABLE `file_shares` (
  ...
  `purpose` enum('share','retention') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'share' COMMENT 'share=外链分享 retention=文件有效期控制',
  ...
  KEY `idx_file_shares_purpose_token` (`purpose`,`token`),
  KEY `idx_file_shares_upload_purpose` (`user_upload_id`,`purpose`),
...
-- ----------------------------
-- Table structure for user_external_upload_auths
-- ----------------------------
DROP TABLE IF EXISTS `user_external_upload_auths`;
CREATE TABLE `user_external_upload_auths` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='第三方上传授权';

-- ----------------------------
-- Records of user_external_upload_auths
-- ----------------------------
BEGIN;
COMMIT;
